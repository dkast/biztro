        ...
        <div className="container z-10 flex flex-col">
          <div className="mt-20 grid grid-cols-1">
            <div className="flex flex-col items-center gap-6 pb-8 text-center">
              {/* Top announcement */}
              <Link href="/blog/beta-biztro" className="hover:cursor-pointer">
                <div
                  className={cn(
                ...
                >
                  <AnimatedShinyText className="inline-flex items-center justify-center px-4 py-1 text-xs transition ease-out hover:cursor-pointer hover:text-gray-600 hover:duration-300 hover:dark:text-gray-400 sm:text-base">
