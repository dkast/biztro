  ...
  return (
    ...
    >
      <NavigationMenuPrimitive.Viewport
        ...
        className={cn(
          `origin-top-center data-[state=open]:animate-in
  ...
  return (
    <NavigationMenuPrimitive.Link
      ...
      className={cn(
        ...
        focus:text-gray-900 focus-visible:ring-[3px]
        focus-visible:ring-gray-950/50 focus-visible:outline-1
        data-[active=true]:bg-gray-100/50 data-[active=true]:text-gray-900
        data-[active=true]:hover:bg-gray-100
        data-[active=true]:focus:bg-gray-100 dark:hover:bg-gray-800
        dark:hover:text-gray-50 dark:focus:bg-gray-800 dark:focus:text-gray-50
        dark:focus-visible:ring-gray-300/50
        dark:data-[active=true]:bg-gray-800/50
        dark:data-[active=true]:text-gray-50
        dark:data-[active=true]:hover:bg-gray-800
        dark:data-[active=true]:focus:bg-gray-800
    ...
    >
      <div
        className="relative top-[60%] h-2 w-2 rotate-45 rounded-tl-sm
          bg-gray-200 shadow-md dark:bg-gray-800"
      />
    </NavigationMenuPrimitive.Indicator>
  )
}
