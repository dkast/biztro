        ...
        className={cn(
          ...
          isSelected && !(isSelectionStart || isSelectionEnd)
            ? `rounded-none bg-gray-100 text-gray-800 hover:bg-gray-100
              hover:text-gray-800 focus:bg-gray-100 focus:text-gray-50
              dark:bg-gray-50 dark:text-gray-900 dark:hover:bg-gray-50
              dark:hover:text-gray-900 dark:focus:bg-gray-50
