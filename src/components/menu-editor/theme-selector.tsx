    ...
    <div className="editor-theme flex flex-col">
      <SideSection title="Tipografía">
        <ThemedSelector
          ...
          triggerContent={
            <button className="flex w-full flex-row items-center justify-between rounded-lg border px-4 py-2 text-left shadow-xs transition-colors dark:border-gray-800 dark:bg-gray-950 dark:hover:bg-gray-800">
              <div>
