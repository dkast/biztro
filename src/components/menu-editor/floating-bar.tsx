...
export default function FloatingBar() {
  ...
  return (
    <div className="editor-toolbar fixed bottom-8 left-1/2 flex h-12 min-w-[200px] -translate-x-1/2 flex-row items-center justify-between rounded-full bg-gray-800 px-1 text-white shadow-lg dark:border dark:border-gray-800 dark:bg-gray-900">
