...
INSERT INTO "new_MenuItem" ("categoryId", "createdAt", "description", "id", "image", "name", "organizationId", "status", "updatedAt") SELECT "categoryId", "createdAt", "description", "id", "image", "name", "organizationId", "status", "updatedAt" FROM "MenuItem";
DROP TABLE "MenuItem";
